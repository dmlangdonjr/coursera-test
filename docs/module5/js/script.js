...
// Remove the class 'active' from home or Menu and switch to About button
...
function buildAndShowAboutHTML(aboutHtml) {
	...
	for(i=1; i <= randomNum; i++) {
		finalHtml = insertProperty(finalHtml, "star" + i, "fa fa-star");
	}
	
	if(randomNum !== 5) {
		for(i=randomNum+1; i <= 5; i++) {
			finalHtml = insertProperty(finalHtml, "star" + i, "far fa-star");
		}
	}
	
	finalHtml += "<span> " + randomNum + "-star rating</span>";
